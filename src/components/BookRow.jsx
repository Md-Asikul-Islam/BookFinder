...
function BookRow({book, onFeatureBook}) {
  return (
    <div className=" w-[clamp(20rem,50vw,80rem)] h-[16rem] sm:h-[20rem] md:h-[18rem] lg:h-[16rem] mx-auto mb-4 p-4 shadow-xl hover:shadow-2xl transition-shadow rounded-2xl bg-white flex gap-x-[1rem] ">
